# Docker Setup for nirmanus Starter

This directory contains Docker configuration for running the nirmanus Starter application in containers.
...
3. **Shell Access**
   ...
   # Access database
   docker-compose exec postgres psql -U postgres -d nirmanus_starter
   ```
