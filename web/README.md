...
<!-- [![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/nirmanus/saas-starter) -->
...
![nirmanus SaaS Starter Kit](./public/og.png)
...
git clone https://github.com/nirmanus/saas-starter.git
...
3. After successful script execution, the user will have super admin (`super_admin`) privileges and can access all management functions under the `/voice/admin` path.
...
This project is licensed under the [MIT](https://github.com/nirmanus/saas-starter/blob/main/LICENSE) license.
