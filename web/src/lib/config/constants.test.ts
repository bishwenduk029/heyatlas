...
describe("Constants Configuration", () => {
  ...
  describe("Configuration consistency", () => {
    ...
    it("should have description that matches the product", async () => {
      ...
      expect(constants.APP_DESCRIPTION.toLowerCase()).toContain("voice");
      expect(constants.APP_DESCRIPTION.toLowerCase()).toContain("companion");
      expect(constants.APP_DESCRIPTION.toLowerCase()).toContain("cloud");
      expect(constants.APP_DESCRIPTION.toLowerCase()).toContain("computer");
    });
  });
});
