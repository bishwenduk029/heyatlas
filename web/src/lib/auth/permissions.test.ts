...
describe("Auth Permissions", () => {
  ...
  describe("requireAdmin", () => {
    ...
    it("should redirect to voice when authenticated as regular user", async () => {
      const mockUser = {
        id: "user-123",
        email: "user@example.com",
        role: "user",
      ...
      await expect(requireAdmin()).rejects.toThrow("NEXT_REDIRECT: /voice");
      expect(mockRedirect).toHaveBeenCalledWith("/voice");
    });
  ...
  describe("requireSuperAdmin", () => {
    ...
    it("should redirect to voice when authenticated as admin", async () => {
      const mockAdmin = {
        id: "admin-123",
        email: "admin@example.com",
        role: "admin",
