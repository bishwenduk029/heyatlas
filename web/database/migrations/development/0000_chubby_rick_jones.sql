...
ALTER TABLE "mcp_configs" ADD CONSTRAINT "mcp_configs_userId_users_id_fk" FOREIGN KEY ("userId") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
CREATE INDEX "payments_userId_idx" ON "payments" USING btree ("userId" text_ops);--> statement-breakpoint
CREATE INDEX "accounts_userId_idx" ON "accounts" USING btree ("userId" text_ops);--> statement-breakpoint
CREATE INDEX "subscriptions_customerId_idx" ON "subscriptions" USING btree ("customerId" text_ops);--> statement-breakpoint
CREATE INDEX "subscriptions_userId_idx" ON "subscriptions" USING btree ("userId" text_ops);--> statement-breakpoint
CREATE INDEX "uploads_fileKey_idx" ON "uploads" USING btree ("fileKey" text_ops);--> statement-breakpoint
CREATE INDEX "uploads_userId_idx" ON "uploads" USING btree ("userId" text_ops);--> statement-breakpoint
CREATE INDEX "webhook_events_eventId_idx" ON "webhook_events" USING btree ("eventId" text_ops);--> statement-breakpoint
CREATE INDEX "webhook_events_provider_idx" ON "webhook_events" USING btree ("provider" text_ops);--> statement-breakpoint
CREATE INDEX "mcp_configs_unique_idx" ON "mcp_configs" USING btree ("userId" text_ops,"agentType" text_ops);--> statement-breakpoint
CREATE INDEX "mcp_configs_userId_idx" ON "mcp_configs" USING btree ("userId" text_ops);
*/
