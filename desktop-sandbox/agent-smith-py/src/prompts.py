...
Available workers:
1. **Browser Agent**: Navigation, form filling, data extraction from websites
2. **Terminal Agent**: Shell commands, file operations, system administration
3. **Research Agent**: Academic paper search (ArXiv), web research, information aggregation
